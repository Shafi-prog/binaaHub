// Medusa API Configuration and Helper Functions
// This file provides the connection and API helpers for integrating with Medusa Commerce
...
// Default configuration - update these values based on your Medusa setup
const defaultConfig: MedusaConfig = {
...
class MedusaAPI {
  ...
  constructor(config: MedusaConfig = defaultConfig) {
    this.config = config;
  }
