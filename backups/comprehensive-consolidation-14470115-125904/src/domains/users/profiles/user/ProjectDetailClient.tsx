...
import { getProjectById, updateProject as updateProjectAPI } from '@/domains/shared/services/api/dashboard';
import { NotificationService, NotificationTypes } from '@/domains/shared/services/notifications';
import { useNotification } from '@/domains/shared/components/ui/NotificationSystem';
import { Card, LoadingSpinner, StatusBadge, ProgressBar } from '@/domains/shared/components/ui';
import { formatCurrency, formatDate, translateStatus, calculateProjectProgress } from '@/domains/shared/utils';
import { MapPicker } from '@/components/maps/MapPicker';
import ProjectIntegrationTabs from '@/domains/users/components/ProjectIntegrationTabs';
import ProjectOrderComponent from '@/domains/users/components/ProjectOrderComponent';
  ...
  useEffect(() => {
    if (user && projectId) {
      fetchProject().catch(error => {
        console.error('Error in ProjectDetailClient fetchProject:', error);
