...
import { CustomerSearchWidget, type Customer as CustomerInterface } from '@/core/shared/components/store/CustomerSearchWidget';
...
export default function SalesOrderManagementPage() {
  const [customers] = useState<SalesCustomer[]>([
    {
      id: '1',
  ...
  const [products] = useState<Product[]>([
    {
      ...
      description: 'أسمنت بورتلاندي عادي 42.5 حسب المواصفات السعودية',
      ...
      unit: 'كيس',
      weight: 50,
      dimensions: '40x30x10 سم',
      manufacturer: 'شركة الأسمنت السعودية'
    },
    {
      id: '2',
      productCode: 'PRD-002',
      name: 'حديد تسليح عالي القوة',
      description: 'حديد تسليح عالي القوة 16 مم حسب المواصفة ASTM A615',
      ...
      unit: 'متر',
      weight: 1.58,
      dimensions: '12000x16 مم',
      manufacturer: 'مصنع الحديد الوطني'
    },
    {
      id: '3',
      productCode: 'PRD-003',
      name: 'طوب أحمر عادي',
      description: 'طوب أحمر عادي للبناء مقاس 25x12x6 سم',
      category: 'مواد البناء',
      unitPrice: 0.45,
      taxRate: 15,
      stockQuantity: 50000,
      ...
      unit: 'قطعة',
      weight: 2.5,
      dimensions: '25x12x6 سم',
      manufacturer: 'مصنع الطوب المتطور'
    }
  ]);
