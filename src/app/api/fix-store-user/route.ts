...
export async function POST(request: NextRequest) {
  try {
    console.log('🔧 [DB-FIX] Starting store user fix...');

    const email = 'teststore@store.com';
    ...
    console.log('✅ [DB-FIX] User record upserted successfully with account_type: store');
    ...
    return NextResponse.json({
      success: true,
      message: 'Store user fixed successfully',
      user: {
        id: userId,
        email: email,
        account_type: 'store',
