  ...
  const [products] = useState<Product[]>([
    {
      ...
      originalPrice: 32.00,
      discount: 11,
      description: 'أسمنت بورتلاندي عالي الجودة مناسب لجميع أنواع البناء والخرسانة',
      specifications: {
        'الوزن': '50 كيلو',
      ...
      rating: 4.8,
      reviewsCount: 124,
      images: ['/placeholder-cement.jpg'],
      tags: ['أسمنت', 'بناء', 'خرسانة'],
      createdAt: '2024-01-15'
    },
    {
      id: '2', 
      name: 'حديد تسليح عالي المقاومة',
      ...
      rating: 4.6,
      reviewsCount: 89,
      images: ['/placeholder-rebar.jpg'],
      tags: ['حديد', 'تسليح', 'بناء'],
    ...
    },
    {
      ...
      originalPrice: 55.00,
      discount: 18,
      description: 'بلاط سيراميك فاخر مقاوم للخدش والماء',
      specifications: {
        'المقاس': '60x60 سم',
        'السماكة': '10 مم',
        'النوع': 'بورسلين',
      ...
      minOrderQuantity: 5,
      unit: 'متر مربع',
      supplier: 'شركة البلاط الأندلسي',
      rating: 4.9,
      reviewsCount: 67,
      images: ['/placeholder-tiles.jpg'],
      tags: ['بلاط', 'سيراميك', 'تشطيبات'],
