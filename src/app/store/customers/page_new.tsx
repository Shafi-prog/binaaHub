  ...
  const [customers] = useState<Customer[]>([
    {
      ...
      tags: ['VIP', 'مورد رئيسي', 'دفع سريع'],
      notes: 'عميل ممتاز مع تاريخ دفع ممتاز'
    },
    {
      id: '2',
      customerCode: 'CUST-002',
      name: 'سارة أحمد الفهد',
      arabicName: 'سارة أحمد الفهد',
      type: 'individual',
      category: {
        id: '2',
        name: 'عميل فضي',
      ...
      tags: ['عميلة منتظمة', 'دفع نقدي'],
      notes: 'عميلة جديدة مع إمكانية نمو'
    },
    {
      id: '3',
      customerCode: 'CUST-003',
      name: 'محمد علي القحطاني',
      arabicName: 'محمد علي القحطاني',
      type: 'business',
      category: {
        id: '3',
        name: 'عميل برونزي',
      ...
      contactInfo: {
        phone: '+966559876543',
        email: 'mohammed.alqahtani@business.com',
      ...
      businessInfo: {
        businessName: 'مؤسسة القحطاني التجارية',
        businessType: 'مؤسسة فردية',
        taxNumber: '987654321',
        commercialRegister: 'CR-9876543210',
        industry: 'مقاولات',
        employeeCount: 8,
        website: 'www.alqahtani-contracting.com'
      },
      financialInfo: {
        creditLimit: 25000,
        currentBalance: -2500,
      ...
      tags: ['مقاول', 'طلبات متكررة'],
      notes: 'عميل جيد مع حاجة لمتابعة الدفعات'
    }
  ]);
