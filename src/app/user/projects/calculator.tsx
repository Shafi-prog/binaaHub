    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-indigo-50/20 font-tajawal">
      <div className="container mx-auto px-6 py-8 max-w-xl">
        <EnhancedCard variant="elevated" className="p-8 mb-8">
          ...
          <div className="mb-4">
            <Typography variant="body" size="md" weight="medium" className="mb-2">مساحة الأرض بالمتر</Typography>
            <div className="flex gap-2">
              <div className="flex-1">
                <label className="block mb-1 text-sm">الطول</label>
                <input 
                  type="number" 
              ...
              <div className="flex-1">
                <label className="block mb-1 text-sm">العرض</label>
                <input 
                  type="number" 
                  className="w-full border rounded px-2 py-1" 
                  value={form.width} 
          ...
          <Button onClick={handleCalculate} className="bg-blue-600 text-white rounded px-4 py-2 w-full">
            إضافة
          </Button>
        </EnhancedCard>
