  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">إدارة أوامر الشراء المتقدمة</h1>
          <p className="text-gray-600">نظام إدارة مشتريات متقدم مع سير عمل الموافقات وتتبع الأداء</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-yellow-600">{pendingApproval}</span>
            </div>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-gray-600">طلبات معتمدة</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="flex items-center gap-2">
              <CheckCircle className="h-5 w-5 text-blue-600" />
              <span className="text-2xl font-bold text-blue-600">{approvedOrders}</span>
            </div>
            <p className="text-xs text-gray-500 mt-1">طلب معتمد</p>
          </CardContent>
        </Card>
