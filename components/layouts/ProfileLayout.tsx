    ...
    <div className="flex min-h-screen font-[Tajawal]">
      ...
      `}>
        ...
        <ul className="space-y-4 text-right">
          <li>
            <Link href="/profile" className="text-blue-600 hover:underline">الملف الشخصي</Link>
          </li>
          <li>
            <Link href="/projects" className="text-blue-600 hover:underline">مشاريعي</Link>
          </li>
          <li>
            <Link href="/orders" className="text-blue-600 hover:underline">الطلبات</Link>
          </li>
          <li>
            <Link href="/settings" className="text-blue-600 hover:underline">الإعدادات</Link>
          </li>
        </ul>
      </div>
