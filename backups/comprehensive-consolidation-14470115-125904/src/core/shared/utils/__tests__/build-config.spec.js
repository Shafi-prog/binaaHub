...
describe("buildSchemaObjectRepresentation", () => {
    ...
    beforeEach(() => {
        jest.clearAllMocks();
        modules_sdk_1.MedusaModule.getAllJoinerConfigs.mockReturnValue([]);
    });
    afterEach(() => {
        jest.resetAllMocks();
    });
    it("should a simple object representation for a single entity", () => {
        ...
        const output = (0, build_config_1.buildSchemaObjectRepresentation)(schema);
    ...
    `;
        const { objectRepresentation, entitiesMap } = (0, build_config_1.buildSchemaObjectRepresentation)(indexSchema);
        expect(entitiesMap).toEqual(expect.objectContaining({
            Product: expect.objectContaining({
                name: "Product",
                _fields: {
    ...
    `;
        ...
        expect(objectRepresentation._schemaPropertiesMap["product"].ref).toEqual(productRefExpectation);
        ...
        expect(objectRepresentation._schemaPropertiesMap["variant"].ref).toEqual(variantRefExpectation);
        expect(objectRepresentation._schemaPropertiesMap["product.variants"]).toBeDefined();
        expect(objectRepresentation._schemaPropertiesMap["product.variants"].ref).toEqual(variantRefExpectation);
    });
    ...
    `;
        ...
        expect(objectRepresentation._schemaPropertiesMap["category"].ref).toEqual(categoryRefExpectation);
        expect(objectRepresentation._schemaPropertiesMap["product"]).toBeDefined();
        expect(objectRepresentation._schemaPropertiesMap["product"].ref).toEqual(productRefExpectation);
        expect(objectRepresentation._schemaPropertiesMap["variant"]).toBeDefined();
        expect(objectRepresentation._schemaPropertiesMap["variant"].ref).toEqual(variantRefExpectation);
        expect(objectRepresentation._schemaPropertiesMap["option"]).toBeDefined();
        expect(objectRepresentation._schemaPropertiesMap["option"].ref).toEqual(optionRefExpectation);
        // Check nested paths
        expect(objectRepresentation._schemaPropertiesMap["category.products"]).toBeDefined();
        expect(objectRepresentation._schemaPropertiesMap["category.products"].ref).toEqual(productRefExpectation);
        expect(objectRepresentation._schemaPropertiesMap["product.variants"]).toBeDefined();
        expect(objectRepresentation._schemaPropertiesMap["product.variants"].ref).toEqual(variantRefExpectation);
        expect(objectRepresentation._schemaPropertiesMap["variant.options"]).toBeDefined();
        expect(objectRepresentation._schemaPropertiesMap["variant.options"].ref).toEqual(optionRefExpectation);
    });
    ...
    `;
        ...
        expect(objectRepresentation["Product"].alias).toBe("product");
        expect(objectRepresentation["Product"].moduleConfig).toBe(productModuleJoinerConfig);
        ...
        expect(objectRepresentation._serviceNameModuleConfigMap).toEqual(expect.objectContaining({
    ...
    `;
        ...
        expect(objectRepresentation["Order"].moduleConfig).toBe(orderModuleJoinerConfig);
        ...
        expect(objectRepresentation["OrderItem"].parents).toEqual(expect.arrayContaining([
            {
                ref: expect.objectContaining({
                    entity: "Order",
                }),
        ...
        expect(objectRepresentation["OrderItem"].moduleConfig).toBe(orderItemLinkModuleJoinerConfig);
    ...
    `;
        ...
        expect(objectRepresentation["ProductVariant"].moduleConfig).toBe(productModuleJoinerConfig);
        expect(objectRepresentation["ProductVariant"].fields).toEqual([
            "id",
            "product_id",
            "title",
        ...
        expect(objectRepresentation["ProductVariantPriceSetLink"].entity).toBe("ProductVariantPriceSetLink");
        ...
        expect(objectRepresentation["PriceSet"].moduleConfig).toBe(priceModuleJoinerConfig);
        ...
        expect(objectRepresentation["Price"].moduleConfig).toBe(priceModuleJoinerConfig);
        // Check that links between services are properly set up
        expect(objectRepresentation._serviceNameModuleConfigMap).toEqual(expect.objectContaining({
            ProductService: productModuleJoinerConfig,
            PriceService: priceModuleJoinerConfig,
            ProductVariantPriceSetService: productVariantPriceSetLinkModuleJoinerConfig,
        }));
    });
    ...
    `;
        ...
        expect(objectRepresentation["ProductVariantPriceLink"].entity).toBe("ProductVariantPriceLink");
        ...
        expect(objectRepresentation["ProductPriceLink"].entity).toBe("ProductPriceLink");
    ...
    `;
        ...
        expect(() => {
            (0, build_config_1.buildSchemaObjectRepresentation)(indexSchema);
        }).toThrow(/unable to retrieve the module that corresponds to the entity Product/);
    });
});
