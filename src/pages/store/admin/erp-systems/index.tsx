                    ...
                    <TableRow key={system.id}>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          <Button variant="ghost" size="sm" title="إعدادات المزامنة" onClick={() => alert('Button clicked')}>
                            <Settings className="h-4 w-4" />
                          </Button>
                          <Button variant="ghost" size="sm" title="تعديل" onClick={() => alert('Button clicked')}>
                            <Edit className="h-4 w-4" />
                          </Button>
                          <Button variant="ghost" size="sm" className="text-red-600" title="حذف" onClick={() => alert('Button clicked')}>
