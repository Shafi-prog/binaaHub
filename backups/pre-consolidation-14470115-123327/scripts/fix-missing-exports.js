...
const exportsToAdd = [
  ...
  {
    file: 'src/domains/shared/services/construction/construction-ecosystem-manager.ts',
    exports: ['ConstructionEcosystemManager']
  },
  // GCC market manager
  {
    file: 'src/domains/shared/services/markets/gcc-market-manager.ts',
    exports: ['GCCMarketManager']
  },
  // Temp auth
  {
    file: 'src/domains/shared/services/temp-auth.ts',
    exports: ['verifyTempAuth', 'clearTempAuth']
  },
  // Notifications
  {
    file: 'src/domains/shared/services/notifications.ts',
    exports: ['NotificationService']
  },
  // Medusa integration
  {
    file: 'src/domains/shared/services/medusa-integration.ts',
    exports: ['syncUserWithMedusa']
  },
  // Supervisor service
  {
    file: 'src/domains/shared/services/supervisor-service.ts',
    exports: ['SupervisorService']
  },
  // ERP MongoDB service
  {
    file: 'src/domains/shared/services/erp/mongodb-service.ts',
    exports: ['initERPService', 'generateId', 'generateOrderNumber', 'generateInvoiceNumber', 'calculateTotal']
  },
  // Excel import service
  {
    file: 'src/domains/shared/services/excel-import.ts',
