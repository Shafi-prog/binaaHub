...
export const adminWorkflowsExecutionsMiddlewares: MiddlewareRoute[] = [
  ...
  {
    method: ["GET"],
    matcher: "/admin/workflows-executions/workflows/:workflow_id/:transaction_id",
    middlewares: [
      validateAndTransformQuery(
        AdminGetWorkflowExecutionDetailsParams,
        QueryConfig.retrieveTransformQueryConfig
  ...
  {
    method: ["POST"],
    matcher: "/admin/workflows-executions/workflows/:workflow_id/run",
    middlewares: [validateAndTransformBody(AdminCreateWorkflowsRun)],
  },
  {
    method: ["POST"],

    matcher: "/admin/workflows-executions/workflows/:workflow_id/steps/success",
    middlewares: [validateAndTransformBody(AdminCreateWorkflowsAsyncResponse)],
  },
  {
    method: ["POST"],
    matcher: "/admin/workflows-executions/workflows/:workflow_id/steps/failure",
    middlewares: [validateAndTransformBody(AdminCreateWorkflowsAsyncResponse)],
  },
]
