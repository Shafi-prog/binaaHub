      ...
      <div className="relative container mx-auto px-4 max-w-4xl py-6 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <div className="mt-6 flex flex-wrap gap-3 text-sm">
            ...
            <Link href="/marketplace" className="bg-white/90 backdrop-blur-sm px-4 py-2 rounded-xl text-blue-600 hover:text-blue-700 hover:bg-white shadow-lg hover:shadow-xl transition-all border border-purple-200/30">مشاريع للبيع</Link>
