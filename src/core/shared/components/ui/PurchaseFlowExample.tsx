...
import { Card, CardContent, CardHeader, CardTitle, Button } from '@/core/shared/components/ui';
import PurchaseAssignmentDialog from '@/core/shared/components/ui/PurchaseAssignmentDialog';
...
export default function PurchaseFlowExample() {
  ...
  const handleAddWarranty = async () => {
    ...
    const exampleWarranty = {
      id: 2001,
      item: exampleOrder.item,
      store: exampleOrder.supplier,
      purchaseDate: exampleOrder.date,
      warrantyYears: 2,
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                <div>
                  ...
                  <p className="font-medium">{exampleOrder.item}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">الكمية</p>
                  <p className="font-medium">{exampleOrder.quantity} كيس</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">التكلفة</p>
                  <p className="font-medium">{exampleOrder.totalCost?.toLocaleString('en-US')} ر.س</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">المورد</p>
                  <p className="font-medium">{exampleOrder.supplier}</p>
                </div>
              </div>
